...
use cim_domain_identity::{
    ...
    OrganizationCommand, OrganizationId, OrganizationType,
};
use cim_domain_identity::domain::{Email, PhoneNumber, Address};
...
mod person_command_tests {
    ...
    fn test_authentication_command_structure() {
        ...
        match command {
            PersonCommand::Authenticate { username: u, password_hash: p } => {
    ...
    fn test_mfa_enablement_commands() {
        ...
        match command {
            PersonCommand::EnableMfa { method: m, backup_codes: codes } => {
...
mod organization_command_tests {
    ...
    fn test_organization_creation_command() {
        ...
        match command {
            OrganizationCommand::CreateOrganization { name: n, org_type: t } => {
                assert_eq!(n, name);
