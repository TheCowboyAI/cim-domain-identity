...
use cim_domain_identity::domain::{Address, AuthMethod, Email, Name, PhoneNumber, TrustLevel};
use cim_domain_identity::IdentityError;
use cim_domain_identity::{
    Organization, OrganizationCommand, OrganizationEvent, OrganizationType, Person, PersonCommand,
...
mod person_aggregate_tests {
    ...
    fn test_person_profile_updates() {
        ...
        let address_command = PersonCommand::ChangeAddress {
...
mod organization_aggregate_tests {
    ...
    fn test_organization_description_updates() {
        ...
        let command = OrganizationCommand::ChangeDescription {
